...
A teammate saw what I was doing, and we had a couple good chuckles about some traps and blind spots that the agents walk right into, like (smartly) [writing unit tests to validate its changes](https://github.com/elastic/elastic-transport-js/pull/344/changes#diff-636284ceac14acac0f90c819c372fe736dbb12b034b94493799266c713ed8741), but then (dumbly) not noticing that [unit test globbing patterns prevented the CI jobs from even running the tests it wrote](https://github.com/elastic/elastic-transport-js/pull/346), which would have failed on Windows in this case had they run.
